...
%compare msprime using ABLE trick (branch lengths, not mutations) to get at bSFS.
...
% at some point complex models will be easier to simulate (and extract bSFS from) rather than use agemo. To what extent have we changed this point. Time of evaluation vs graph complexity.
